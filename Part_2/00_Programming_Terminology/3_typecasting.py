...
def type_converter() -> str | float:
    user_num: float = float(input("Please type in a number: "))

    converted_num = int(user_num)

    print(user_num)
    print(converted_num)
    print(f"Integer part: {converted_num}")
    print(f"Decimal part: {user_num - converted_num}")
