...
print(f"The sum of the number is {user_first_number + user_second_number + user_third_number + user_fourth_number} and the mean is {(user_first_number + user_second_number + user_third_number + user_fourth_number) / 4}")
