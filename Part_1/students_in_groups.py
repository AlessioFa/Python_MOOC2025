...
student_course: int = int(input("How many students on the course? "))
group_size: int = int(input("Desired group size? "))

number_of_group: int = student_course // group_size

print("How many students on the course?", student_course)
print("Desired group size?", group_size)
